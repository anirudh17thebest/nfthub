  ...
  return (
    <div className="bg-[#131835] py-10">
      <div className="w-4/5 mx-auto">
        <h4 className="text-gradient uppercase text-4xl">Artworks</h4>
          ...
          {nfts.map((nft, i) => (
            <a
              ...
              className="relative shadow-xl shadow-black p-3
                bg-white rounded-lg item w-80 h-80 object-contain 
                bg-no-repeat bg-cover overflow-hidden mt-10 mr-10 mb-2 cursor-pointer
